...
@Service
@Slf4j
public class DefaultPerformersDao implements PerformersDao{
	@Autowired
	private NamedParameterJdbcTemplate jdbcTemplate;

	@Override
	public List<Performers> fetchPerformers(String first_name, String last_name) {
		log.info("The fetchPeformers method was called with first_name={} and last_name={}", first_name, last_name);
		// formatter:off
				String sql = ""
					+ "SELECT * "
					+ "FROM performers "
